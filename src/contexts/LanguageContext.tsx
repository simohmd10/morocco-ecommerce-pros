...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'portfolio.1': 'متجر أزياء نسائية',
    'portfolio.2': 'متجر إلكترونيات',
    'portfolio.3': 'متجر مستحضرات تجميل',
    // FAQ
  ...
  fr: {
    ...
    'portfolio.1': 'Mode Femme',
    'portfolio.2': 'Électronique',
    'portfolio.3': 'Cosmétiques',
  ...
  en: {
    ...
    'portfolio.1': 'Fashion Store',
    'portfolio.2': 'Electronics Store',
    'portfolio.3': 'Cosmetics Store',
