...
const Footer = () => {
  ...
  const whatsappUrl = "https://wa.me/212691553120";
  ...
  return (
    <footer className="dark-section relative overflow-hidden" role="contentinfo">
      ...
      <div className="container mx-auto px-4 pt-10 md:pt-14 pb-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 mb-10 md:mb-12">
          ...
          <address className="not-italic">
            ...
            <div className="flex flex-col gap-3 mb-5">
              ...
              >
                <div className="w-7 h-7 rounded-lg bg-white/5 border border-white/8 flex items-center justify-center group-hover:border-gold/30 transition-colors flex-shrink-0">
            ...
            {/* ✅ FIX: استبدال "واتساب" بـ t() */}
            <a
              href={whatsappUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold text-dark transition-all hover:-translate-y-px active:scale-[0.98]"
        ...
        <div className="border-t border-white/8 pt-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-center">
          ...
          <div className="flex items-center gap-1.5">
            <span className="text-xs text-white/20">{t('footer.made')}</span>
            <span className="text-gold text-xs">♦</span>
            <span className="text-xs text-white/20">Morocco</span>
          </div>
        </div>
